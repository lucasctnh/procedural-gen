Shader "Custom/Terrain"
{
    ...
    SubShader
    {
        ...
        float baseColoursStrength[maxLayerCount];
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            for (int i = 0; i < layerCount; i++)
            {
                ...
                float3 baseColour = baseColours[i] * baseColoursStrength[i];
                float3 textureColour = triplanar(IN.worldPos, baseTextureScales[i], blendAxis, i) * (1 - baseColoursStrength[i]);
